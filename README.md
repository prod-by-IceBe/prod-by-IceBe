...
### 👨‍💻 О себе
Я фронтенд-разработчик, который превращает сложные макеты в интуитивно понятные интерфейсы. Моя страсть — чистый код и высокая производительность.

* 🛠 **Инструменты:** Основную магию творю в **VS Code**.
* 🎨 **Принципы:** Pixel Perfect верстка, адаптивность «из коробки» и внимание к деталям.
* 📚 **Вектор:** Углубляюсь в архитектуру приложений и оптимизацию рендеринга.
...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=js,ts,html,css,react,sass,vscode,git,webpack,figma,redux,nextjs" />
  </a>
</p>
